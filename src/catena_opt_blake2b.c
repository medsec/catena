...
int __Catena(const uint8_t *pwd,       const uint32_t pwdlen,
	     ...
	     const uint8_t min_garlic, const uint8_t garlic,
	     const uint8_t hashlen,    const uint8_t client,
...
{
  return __Catena(pwd, pwdlen, salt, saltlen, data, datalen, MIN_GARLIC,
		  garlic, hashlen, REGULAR, PASSWORD_HASHING_MODE, hash);
}
...
int Simple_Catena(const char *pwd,  const char *salt, const char *data,
  ...
  return __Catena( (uint8_t  *) pwd, strlen(pwd),
		   ...
		   MIN_GARLIC, garlic, H_LEN, REGULAR,
		   PASSWORD_HASHING_MODE, hash);
}
...
int Catena_Client(const uint8_t  *pwd,   const uint32_t pwdlen,
		  ...
		  uint8_t x[H_LEN])
{
  return __Catena(pwd, pwdlen, (uint8_t *) salt, saltlen,
		  data, datalen, MIN_GARLIC, garlic, hashlen,
...
int PHS(void *out, size_t outlen,  const void *in, size_t inlen,
  ...
  return __Catena((const uint8_t *) in, inlen, salt, saltlen, (const uint8_t *)
		  "", 0, MIN_GARLIC, m_cost, outlen, REGULAR, PASSWORD_HASHING_MODE, out);
}
